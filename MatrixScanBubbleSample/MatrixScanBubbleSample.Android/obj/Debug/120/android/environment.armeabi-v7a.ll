...
@__DSOCacheEntry_name.5 = internal constant [32 x i8] c"libscanditsdk-android-6.14.0.so\00", align 1
@__DSOCacheEntry_name.6 = internal constant [10 x i8] c"libbar.so\00", align 1
@__DSOCacheEntry_name.7 = internal constant [18 x i8] c"libsdc-barcode.so\00", align 1
@__DSOCacheEntry_name.8 = internal constant [15 x i8] c"libsdc-core.so\00", align 1
...
@dso_cache = local_unnamed_addr global [44 x %struct.DSOCacheEntry] [
	...
	; 4
	%struct.DSOCacheEntry {
		i64 429875914, ; hash 0x199f62ca, from name: libscanditsdk-android-6.14.0.so
		i8 0, ; ignore
	...
	; 8
	%struct.DSOCacheEntry {
		i64 902953023, ; hash 0x35d1f83f, from name: libbar.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 9
	%struct.DSOCacheEntry {
		i64 1060250128, ; hash 0x3f322210, from name: sdc-barcode.so
		i8 0, ; ignore
	...
	; 10
	%struct.DSOCacheEntry {
		i64 1101146924, ; hash 0x41a22b2c, from name: bar
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 11
	%struct.DSOCacheEntry {
		i64 1191915140, ; hash 0x470b2e84, from name: libsdc-core
		i8 0, ; ignore
	...
	; 13
	%struct.DSOCacheEntry {
		i64 1311851014, ; hash 0x4e314206, from name: libsdc-core.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 14
	%struct.DSOCacheEntry {
		i64 1313150904, ; hash 0x4e4517b8, from name: libsdc-barcode.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 16
	%struct.DSOCacheEntry {
		i64 1510957578, ; hash 0x5a0f620a, from name: libscanditsdk-android-6.14.0
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 20
	%struct.DSOCacheEntry {
		i64 2138189422, ; hash 0x7f722e6e, from name: sdc-barcode
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 22
	%struct.DSOCacheEntry {
		i64 2408696496, ; hash 0x8f91cab0, from name: sdc-core
		i8 0, ; ignore
		i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 25
	%struct.DSOCacheEntry {
		i64 2607624718, ; hash 0x9b6d320e, from name: scanditsdk-android-6.14.0.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 29
	%struct.DSOCacheEntry {
		i64 2916284751, ; hash 0xadd2f94f, from name: libbar
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 30
	%struct.DSOCacheEntry {
		i64 3040703691, ; hash 0xb53d74cb, from name: scanditsdk-android-6.14.0
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 32
	%struct.DSOCacheEntry {
		i64 3204819281, ; hash 0xbf05a951, from name: bar.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 33
	%struct.DSOCacheEntry {
		i64 3295509970, ; hash 0xc46d7dd2, from name: sdc-core.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 43
	%struct.DSOCacheEntry {
		i64 4227773779, ; hash 0xfbfeb553, from name: libsdc-barcode
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}
