...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"d586bb70-648e-4a80-9577-bc326ff8f3e1\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [28 x i8] c"com.xamarinbarcode_test.app\00", align 16
...
@__DSOCacheEntry_name.3 = internal constant [15 x i8] c"libsdc-core.so\00", align 1
@__DSOCacheEntry_name.4 = internal constant [31 x i8] c"libxamarin-debug-app-helper.so\00", align 16
@__DSOCacheEntry_name.5 = internal constant [18 x i8] c"libsdc-barcode.so\00", align 16
@__DSOCacheEntry_name.6 = internal constant [23 x i8] c"libmono-btls-shared.so\00", align 16
@__DSOCacheEntry_name.7 = internal constant [10 x i8] c"libbar.so\00", align 1
@__DSOCacheEntry_name.8 = internal constant [32 x i8] c"libscanditsdk-android-6.14.0.so\00", align 16
...
@dso_cache = local_unnamed_addr global [44 x %struct.DSOCacheEntry] [
	...
	; 2
	%struct.DSOCacheEntry {
		i64 2397411938298009162, ; hash 0x21455174b288964a, from name: sdc-core
		i8 0, ; ignore
	...
	; 4
	%struct.DSOCacheEntry {
		i64 2909454702383082745, ; hash 0x286075a309a22cf9, from name: libsdc-barcode.so
		i8 0, ; ignore
	...
	; 6
	%struct.DSOCacheEntry {
		i64 3564299721429832263, ; hash 0x3176efb650d95247, from name: libbar
		i8 0, ; ignore
	...
	; 9
	%struct.DSOCacheEntry {
		i64 5234164152756840025, ; hash 0x48a37c90ad27a659, from name: bar
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 12
	%struct.DSOCacheEntry {
		i64 7119225803977160750, ; hash 0x62cc922641da782e, from name: scanditsdk-android-6.14.0
		i8 0, ; ignore
	...
	; 17
	%struct.DSOCacheEntry {
		i64 8071625056185357392, ; hash 0x70042c392a121450, from name: sdc-barcode.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 19
	%struct.DSOCacheEntry {
		i64 8461234029689841765, ; hash 0x756c57853d1c2865, from name: libsdc-barcode
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 23
	%struct.DSOCacheEntry {
		i64 9347520406428543155, ; hash 0x81b91048cbe368b3, from name: bar.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 24
	%struct.DSOCacheEntry {
		i64 9565790309146370230, ; hash 0x84c0839abc8b20b6, from name: sdc-core.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 28
	%struct.DSOCacheEntry {
		i64 11573016757982328321, ; hash 0xa09b9d6cc72df601, from name: libsdc-core
		i8 0, ; ignore
		i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 29
	%struct.DSOCacheEntry {
		i64 12760953344151393750, ; hash 0xb1180374c17a15d6, from name: scanditsdk-android-6.14.0.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 31
	%struct.DSOCacheEntry {
		i64 13061585382461152932, ; hash 0xb54412b3bd081ea4, from name: libbar.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 35
	%struct.DSOCacheEntry {
		i64 15097491392253667142, ; hash 0xd185106e6acc2746, from name: libsdc-core.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 36
	%struct.DSOCacheEntry {
		i64 15944559551248392921, ; hash 0xdd46746f1838e2d9, from name: sdc-barcode
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 37
	%struct.DSOCacheEntry {
		i64 16002721168972307266, ; hash 0xde15161dfc37db42, from name: libscanditsdk-android-6.14.0
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 41
	%struct.DSOCacheEntry {
		i64 17063075940208844211, ; hash 0xeccc3929dfa99db3, from name: libscanditsdk-android-6.14.0.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
