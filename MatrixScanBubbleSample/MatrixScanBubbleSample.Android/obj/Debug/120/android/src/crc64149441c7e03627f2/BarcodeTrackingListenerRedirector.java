package crc64149441c7e03627f2;


public class BarcodeTrackingListenerRedirector
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Scandit.DataCapture.Barcode.Tracking.Capture.Unified.Implementation.BarcodeTrackingListenerRedirector, ScanditBarcodeCaptureUnified", BarcodeTrackingListenerRedirector.class, __md_methods);
	}


	public BarcodeTrackingListenerRedirector ()
	{
		super ();
		if (getClass () == BarcodeTrackingListenerRedirector.class) {
			mono.android.TypeManager.Activate ("Scandit.DataCapture.Barcode.Tracking.Capture.Unified.Implementation.BarcodeTrackingListenerRedirector, ScanditBarcodeCaptureUnified", "", this, new java.lang.Object[] {  });
		}
	}
