...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "MatrixScanBubbleSample.Android.dll" comes first in this list. */
		"MatrixScanBubbleSample.Android.dll",
		"FormsViewGroup.dll",
		"MatrixScanBubbleSample.dll",
		"ScanditBarcodeCapture.dll",
		"ScanditBarcodeCaptureUnified.dll",
		"ScanditCaptureCore.dll",
		"ScanditCaptureCoreUnified.dll",
		"Square.OkHttp3.dll",
		"Square.OkIO.dll",
