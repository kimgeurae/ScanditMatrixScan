...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Scandit.DataCapture.Core.Capture.DataCaptureContextListenerImplementor, ScanditCaptureCore", DataCaptureContextListenerImplementor.class, __md_methods);
	}
	...
	public DataCaptureContextListenerImplementor ()
	{
		...
		if (getClass () == DataCaptureContextListenerImplementor.class) {
			mono.android.TypeManager.Activate ("Scandit.DataCapture.Core.Capture.DataCaptureContextListenerImplementor, ScanditCaptureCore", "", this, new java.lang.Object[] {  });
		}
	}

	public DataCaptureContextListenerImplementor (com.scandit.datacapture.core.capture.DataCaptureContext p0)
	{
		super ();
		if (getClass () == DataCaptureContextListenerImplementor.class) {
			mono.android.TypeManager.Activate ("Scandit.DataCapture.Core.Capture.DataCaptureContextListenerImplementor, ScanditCaptureCore", "Scandit.DataCapture.Core.Capture.DataCaptureContext, ScanditCaptureCore", this, new java.lang.Object[] { p0 });
		}
	}
