...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Scandit.DataCapture.Barcode.Selection.Capture.BarcodeSelectionListenerImplementor, ScanditBarcodeCapture", BarcodeSelectionListenerImplementor.class, __md_methods);
	}
	...
	public BarcodeSelectionListenerImplementor ()
	{
		...
		if (getClass () == BarcodeSelectionListenerImplementor.class) {
			mono.android.TypeManager.Activate ("Scandit.DataCapture.Barcode.Selection.Capture.BarcodeSelectionListenerImplementor, ScanditBarcodeCapture", "", this, new java.lang.Object[] {  });
		}
	}
