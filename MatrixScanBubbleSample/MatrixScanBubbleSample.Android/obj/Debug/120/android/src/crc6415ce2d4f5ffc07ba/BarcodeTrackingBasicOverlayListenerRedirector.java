...
public class BarcodeTrackingBasicOverlayListenerRedirector
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Scandit.DataCapture.Barcode.Tracking.UI.Unified.Implementation.BarcodeTrackingBasicOverlayListenerRedirector, ScanditBarcodeCaptureUnified", BarcodeTrackingBasicOverlayListenerRedirector.class, __md_methods);
	}


	public BarcodeTrackingBasicOverlayListenerRedirector ()
	{
		super ();
		if (getClass () == BarcodeTrackingBasicOverlayListenerRedirector.class) {
			mono.android.TypeManager.Activate ("Scandit.DataCapture.Barcode.Tracking.UI.Unified.Implementation.BarcodeTrackingBasicOverlayListenerRedirector, ScanditBarcodeCaptureUnified", "", this, new java.lang.Object[] {  });
		}
	}
