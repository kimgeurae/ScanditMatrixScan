...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Scandit.DataCapture.Barcode.Tracking.Capture.BarcodeTrackingListenerImplementor, ScanditBarcodeCapture", BarcodeTrackingListenerImplementor.class, __md_methods);
	}
	...
	public BarcodeTrackingListenerImplementor ()
	{
		...
		if (getClass () == BarcodeTrackingListenerImplementor.class) {
			mono.android.TypeManager.Activate ("Scandit.DataCapture.Barcode.Tracking.Capture.BarcodeTrackingListenerImplementor, ScanditBarcodeCapture", "", this, new java.lang.Object[] {  });
		}
	}
