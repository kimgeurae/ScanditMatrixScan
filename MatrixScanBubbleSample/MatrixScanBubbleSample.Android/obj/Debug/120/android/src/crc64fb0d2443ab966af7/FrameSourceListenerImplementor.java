...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Scandit.DataCapture.Core.Source.FrameSourceListenerImplementor, ScanditCaptureCore", FrameSourceListenerImplementor.class, __md_methods);
	}
	...
	public FrameSourceListenerImplementor ()
	{
		...
		if (getClass () == FrameSourceListenerImplementor.class) {
			mono.android.TypeManager.Activate ("Scandit.DataCapture.Core.Source.FrameSourceListenerImplementor, ScanditCaptureCore", "", this, new java.lang.Object[] {  });
		}
	}
