package crc64fe62b7c45d1fc25b;


public class BarcodeCaptureListenerRedirector
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Scandit.DataCapture.Barcode.Capture.Unified.Implementation.BarcodeCaptureListenerRedirector, ScanditBarcodeCaptureUnified", BarcodeCaptureListenerRedirector.class, __md_methods);
	}


	public BarcodeCaptureListenerRedirector ()
	{
		super ();
		if (getClass () == BarcodeCaptureListenerRedirector.class) {
			mono.android.TypeManager.Activate ("Scandit.DataCapture.Barcode.Capture.Unified.Implementation.BarcodeCaptureListenerRedirector, ScanditBarcodeCaptureUnified", "", this, new java.lang.Object[] {  });
		}
	}
