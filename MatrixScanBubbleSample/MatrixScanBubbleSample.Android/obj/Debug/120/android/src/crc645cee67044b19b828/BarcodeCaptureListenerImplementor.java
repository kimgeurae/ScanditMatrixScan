...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Scandit.DataCapture.Barcode.Capture.BarcodeCaptureListenerImplementor, ScanditBarcodeCapture", BarcodeCaptureListenerImplementor.class, __md_methods);
	}
	...
	public BarcodeCaptureListenerImplementor ()
	{
		...
		if (getClass () == BarcodeCaptureListenerImplementor.class) {
			mono.android.TypeManager.Activate ("Scandit.DataCapture.Barcode.Capture.BarcodeCaptureListenerImplementor, ScanditBarcodeCapture", "", this, new java.lang.Object[] {  });
		}
	}
