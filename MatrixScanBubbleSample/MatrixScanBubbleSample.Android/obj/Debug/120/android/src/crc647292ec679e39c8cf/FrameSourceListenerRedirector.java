...
public class FrameSourceListenerRedirector
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Scandit.DataCapture.Core.Source.Unified.Implementation.FrameSourceListenerRedirector, ScanditCaptureCoreUnified", FrameSourceListenerRedirector.class, __md_methods);
	}
	...
	public FrameSourceListenerRedirector ()
	{
		...
		if (getClass () == FrameSourceListenerRedirector.class) {
			mono.android.TypeManager.Activate ("Scandit.DataCapture.Core.Source.Unified.Implementation.FrameSourceListenerRedirector, ScanditCaptureCoreUnified", "", this, new java.lang.Object[] {  });
		}
	}
